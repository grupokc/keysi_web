...
interface BonosRangos459Props {
    Bono_Periodo: string;
}

const BonosRangos459: React.FC<BonosRangos459Props> = ({ Bono_Periodo }) => {
                        ...
                        <div className="mt-3 flex flex-col">
                            <div className="min-w-full overflow-hidden overflow-x-auto align-middle shadow sm:rounded-lg">
                                <h1 className="text-sm font-semibold bg-blue-300 p-4"> 
                                    <div> 
                                        <b>La clasificación se calcúla con base en el promedio mensual de pólizas vigentes de vida y de Gastos Médicos</b><br/>
                                        ...
                                        Tu PCA es de: ${dollarUSLocale.format(dataBonoRango[0].PCA)}<br/>
                                        Tu Prima Pagada de 1er año GMM  es de: ${dollarUSLocale.format(dataBonoRango[0].PP)}
                                    </div>
                                </h1>
