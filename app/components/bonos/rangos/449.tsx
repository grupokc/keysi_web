...
interface BonosRangos449Props {
    Bono_Periodo: string;
}

const BonosRangos449: React.FC<BonosRangos449Props> = ({ Bono_Periodo }) => {
                            ...
                            <div className="min-w-full overflow-hidden overflow-x-auto align-middle shadow sm:rounded-lg">
                                <h1 className="text-sm font-semibold bg-blue-300 p-4"> 
                                    <div> 
                                        ...
                                        Tu PP es de: ${dollarUSLocale.format(dataBonoRango[0].PP)}
                                    </div>
                                </h1>
