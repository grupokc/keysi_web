...
interface BonosRangos443Props {
    Bono_Periodo: string;
}

const BonosRangos443: React.FC<BonosRangos443Props> = ({ Bono_Periodo }) => {
                        ...
                        <div className="mt-3 flex flex-col">
                            <div className="min-w-full overflow-hidden overflow-x-auto align-middle shadow sm:rounded-lg">
                                <h1 className="text-sm font-semibold bg-blue-300 p-4"> 
                                    <div> FECHA {dataBonoRango[0].Fecha} </div>
                                    <div> 
                                        SE CALCULA CON BASE EN LA PRIMA PONDERADA AJUSTADA DE 1ER AÑO (PP) (${dollarUSLocale.format(dataBonoRango[0].PPGM)}).<br />
                                        SE OTORGA UN PORCENTAJE SOBRE LA PRIMA PAGADA DE RENOVACION (PPR) (${dollarUSLocale.format(dataBonoRango[0].AUTOMATICO)}).<br />
