...
export default function BonosRangos143({Bono_Periodo}){
                    ...
                    <div className="mt-3 flex flex-col">
                        <div className="min-w-full overflow-hidden overflow-x-auto align-middle shadow sm:rounded-lg">
                            <h1 scope="col" className="text-sm font-semibold bg-blue-300 p-4"> 
                                <div> 
                                    LA PCA DE TU PROMOTORIA PARA ESTE BONO  ES DE :${dollarUSLocale.format(dataBonoRango[0].PCA)} &nbsp;
                                </div>
                            ...
                            <div className="bg-blue-300 p-3">
                                Este bono se otorga en Efectivo y se paga a mes vencido
                            </div>
                        </div>
                    </div>
                </div>
