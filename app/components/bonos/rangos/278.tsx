...
interface BonosRangos278Props {
    Bono_Periodo: string;
}

const BonosRangos278: React.FC<BonosRangos278Props> = ({ Bono_Periodo }) => {
        ...
        <>
            { 
                dataBonoRango.length > 0 ? (
                                                        ...
                                                        if (iCeros < 100 || filaAmarilla) {
                                                            banda = (
                                                                <tr className={filaAmarilla ? 'bg-yellow-200' : 'bg-white'} key={index}>
                                                                    ...
                                                                    <td className="whitespace-nowrap py-4 pl-4 pr-3 text-center text-sm font-medium text-gray-900 sm:pl-6">{dollarUSLocale.format(bonoRango.Prima_Limite_Inferior)} - {dollarUSLocale.format(bonoRango.Prima_Limite_Superior)}</td>
                    ...
                    <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
                        <div className="mt-3 flex flex-col">
                            <h1 className="min-w-full overflow-hidden overflow-x-auto align-middle shadow sm:rounded-lg">
                                <h1 className="text-sm font-semibold bg-blue-300 p-4">
                                    Si tu persistencia es menor a 85% no se muestra la tabla de bonos.
                                </h1>
                                <div>
