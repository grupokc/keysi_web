...
interface BonosRangos457Props {
    Bono_Periodo: string;
}

const BonosRangos457: React.FC<BonosRangos457Props> = ({ Bono_Periodo }) => {
                            ...
                            <div className="min-w-full overflow-hidden overflow-x-auto align-middle shadow sm:rounded-lg">
                                <h1 className="text-sm font-semibold bg-blue-300 p-4"> 
                                    <div> 
                                        ...
                                        Tu Prima pagada del 1er Año GMM es de: ${dollarUSLocale.format(dataBonoRango[0].PP)}<br />
                                    </div>
                                </h1>
