...
export default function BonosRangos160({ Bono_Periodo }) {
                        ...
                        <div className="mt-3 flex flex-col">
                            <div className="min-w-full overflow-hidden overflow-x-auto align-middle shadow sm:rounded-lg">
                                <h1 scope="col" className="text-sm font-semibold bg-blue-300 p-4">
                                    <ul>
                                        <li> Se calcula con base en la prima ponderada de 1 er Año (PPGM) ( ${dollarUSLocale.format(dataBonoRango[0].PPGM)}).</li>
                                        <li> NOTA: SE AJUSTARÁN LOS PAGOS EFECTUADOS DE LOS TRIMESTRES ANTERIORES.</li>
                                        {/* <li> Se otorga sobre la prima pagada de 1er Año GMM (PP) ({dollarUSLocale.format(dataBonoRango[0].PP)}).</li> */}
                                    </ul>
