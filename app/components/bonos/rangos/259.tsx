...
interface BonosRangos259Props {
    Bono_Periodo: string;
}

const BonosRangos259: React.FC<BonosRangos259Props> = ({ Bono_Periodo }) => {
                        ...
                        <div className="mt-3 flex flex-col">
                            <div className="min-w-full overflow-hidden overflow-x-auto align-middle shadow sm:rounded-lg">
                                <h1 className="text-sm font-semibold bg-blue-300 p-4">
                                    ...
                                    <div>
                                        <div>
                                        Se calcula con base en la Prima Ponderada de 1 er Año (PPGM) (${dollarUSLocale.format(dataBonoRango[0].PPGM)}).<br />
                                        Se otorga Porcentaje sobre la Prima Pagada de 1 er Año GMM (PP) (${dollarUSLocale.format(dataBonoRango[0].PP)}). <br />
                                        </div>
                                    </div>
                                </h1>
