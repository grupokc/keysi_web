...
export default function BonosRangos216({Bono_Periodo}){
                    ...
                    <div className="mt-3 flex flex-col">
                        <div className="min-w-full overflow-hidden overflow-x-auto align-middle shadow sm:rounded-lg">
                            ...
                            {/* <div> FECHA {dataBonoRango[0].Fecha} </div> */}
                                <div> 
                                    SE CALCULA CON BASE EN LA PCA  (${dollarUSLocale.format(dataBonoRango[0].PCA)} ) <br/>
                                    SE OTORGA UN PORCENTAJE SOBRE LA PCC  ( ${dollarUSLocale.format(dataBonoRango[0].PCC)})  <br/>
                            ...
                            <div className="bg-blue-300 p-3">
                                <li>Puedes alcanzar un 1% adicional si tu persistencia llega a 99%.</li>
                                <li>NOTA: SE AJUSTARÁN LOS PAGOS EFECTUADOS DE LOS TRIMESTRES ANTERIORES.</li>
                            </div>
                        </div>
                    </div>
                </div>
