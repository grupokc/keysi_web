...
interface BonosRangos253Props {
    Bono_Periodo: string;
}

const BonosRangos253: React.FC<BonosRangos253Props> = ({ Bono_Periodo }) => {
                        ...
                        <div className="mt-3 flex flex-col">
                            <div className="min-w-full overflow-hidden overflow-x-auto align-middle shadow sm:rounded-lg">
                                <h1 className="text-sm font-semibold bg-blue-300 p-4"> 
                                    <div> 
                                        <b>La clasificación se calcula con base en el promedio mensual de pólizas de vida</b><br/>
                                        ...
                                        <b>Se otorga Porcentaje sobre la Prima Computable Ajustada de 1er Año</b><br/>
