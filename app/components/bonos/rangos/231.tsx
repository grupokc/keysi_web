...
interface BonosRangos231Props {
  Bono_Periodo: string;
}

const BonosRangos231: React.FC<BonosRangos231Props> = ({ Bono_Periodo }) => {
          ...
          <div className="mt-3 flex flex-col">
            <div className="min-w-full overflow-hidden overflow-x-auto align-middle shadow sm:rounded-lg">
              <h1 className="bg-blue-300 p-4 text-sm font-semibold">
                <div>
                  <b>
                    La clasificación se calcula con base en el promedio mensual
                    de pólizas de vida
                  </b>
                  <br />
                  Tus pólizas del periodo:{' '}
                  {dollarUSLocale.format(dataBonoRango[0].DIRECTO)}. Tu promedio
                  mensual: {dollarUSLocale.format(dataBonoRango[0].AUTOMATICO)}
                  <br />
                  <br />
                  <b>
                    Se otorga Porcentaje sobre la Prima Computable Ajustada de
                    1er Año
                  </b>
                  <br />
                  Tu PCA es de: {dollarUSLocale.format(dataBonoRango[0].PCA)}
                  <br />
                  NOTA: SE AJUSTARÁN LOS PAGOS EFECTUADOS DE LOS TRIMESTRES
                  ANTERIORES.
                </div>
              </h1>
