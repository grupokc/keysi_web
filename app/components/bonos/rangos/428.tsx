...
interface BonosRangos428Props {
    Bono_Periodo: string;
}

const BonosRangos428: React.FC<BonosRangos428Props> = ({ Bono_Periodo }) => {
                        ...
                        <div className="mt-3 flex flex-col">
                            <div className="min-w-full overflow-hidden overflow-x-auto align-middle shadow sm:rounded-lg">
                                <h1 className="text-sm font-semibold bg-blue-300 p-4">
                                    <div> 
                                        SE CALCULA Y SE OTORGA SOBRE LA PRIMA PAGADA PRIMER AÑO (${dollarUSLocale.format(dataBonoRango[0].PP)}).<br />
                                    </div>
                                </h1>
