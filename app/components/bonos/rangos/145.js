...
export default function BonosRangos144({Bono_Periodo}){
                    ...
                    <div className="mt-3 flex flex-col">
                        <div className="min-w-full overflow-hidden overflow-x-auto align-middle shadow sm:rounded-lg">
                            ...
                            <div> 
                                    ...
                                    { dataBonoRango[0].DIRECTO == 1 ? <span> Tienes un Agente Productivo.</span> :null } 
                                    { dataBonoRango[0].DIRECTO > 1 ? <span> Tienes {dataBonoRango[0].DIRECTO} Agente Productivo. </span>: null } 
                                    { dataBonoRango[0].DIRECTO ==0 ? <span> No tienes Agentes Productivos.</span> :null } 
                                </div>
                            ...
                            <div className="bg-blue-300 p-3">
                                ...
                                SE AJUSTARÁN LOS PAGOS EFECTUADOS DE LOS TRIMESTRES ANTERIORES.
                            </div>
                        </div>
                    </div>
                </div>
