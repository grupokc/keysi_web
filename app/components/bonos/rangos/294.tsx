...
interface BonosRangos294Props {
  Bono_Periodo: string;
}

const BonosRangos294: React.FC<BonosRangos294Props> = ({ Bono_Periodo }) => {
          ...
          <div className="mt-3 flex flex-col">
            <div className="min-w-full overflow-hidden overflow-x-auto align-middle shadow sm:rounded-lg">
              <h1 className="bg-blue-300 p-4 text-sm font-semibold">
                <div>
                Se calcula y se otorga sobre : La prima pagada de primer año GMM
                  (PP) (${dollarUSLocale.format(dataBonoRango[0].PP)}).
                </div>
                <div className="mt-2">
