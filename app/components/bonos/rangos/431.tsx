...
interface BonosRangos431Props {
  Bono_Periodo: string;
}

const BonosRangos431: React.FC<BonosRangos431Props> = ({ Bono_Periodo }) => {
  ...
  return (
    <>
      {dataBonoRango && dataBonoRango.length > 0 ? (
