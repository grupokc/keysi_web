...
interface BonosRangos238Props {
    Bono_Periodo: string;
}

const BonosRangos238: React.FC<BonosRangos238Props> = ({ Bono_Periodo }) => {
                        ...
                        <div className="min-w-full overflow-hidden overflow-x-auto align-middle shadow sm:rounded-lg">
                            <h1 className="text-sm font-semibold bg-blue-300 p-4">
                                <div>
                                    ...
                                    Tu PPGM es de: ${dollarUSLocale.format(dataBonoRango[0].PPGM)} <br /><br />
                                    NOTAS:
                                    <ul>
                                        <li>Sólo se pagará el máximo entre el Activity Ratio Mix y la suma del Activity Ratio Vida más el Activity Ratio GMM</li>
                                        <li>SE AJUSTARÁN LOS PAGOS EFECTUADOS DE LOS TRIMESTRES ANTERIORES.</li>
                                    </ul>
                                </div>
                            </h1>
