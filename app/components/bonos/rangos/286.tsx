...
interface BonosRangos286Props {
    Bono_Periodo: string;
}

const BonosRangos286: React.FC<BonosRangos286Props> = ({ Bono_Periodo }) => {
                    ...
                    <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 ">
                        <div className="mt-3 flex flex-col">
                            <div className="min-w-full overflow-hidden overflow-x-auto align-middle shadow sm:rounded-lg">
                                ...
                                <div className="text-sm font-semibold bg-red-100 p-4"> 
                                    Nota: Para el pago del Bono de Renovación Ajuste Anual, el agente debe de cumplir con al menos 4 pólizas con pago anual (incluyen meses sin intereses) de Metalife o Vida Tradicional.
                                    escenarios:



                                    <ul> 
                                        <li> 4 pólizas MetaLife</li>
                                        <li>2 Metalife y Tradicional </li> 
                                        <li>3 Metalife y 1 Tradicional</li> 
                                    </ul>
                                </div>
