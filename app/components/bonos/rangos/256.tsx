...
interface BonosRangos256Props {
    Bono_Periodo: string;
}

const BonosRangos256: React.FC<BonosRangos256Props> = ({ Bono_Periodo }) => {
                            ...
                            <div className="min-w-full overflow-hidden overflow-x-auto align-middle shadow sm:rounded-lg">
                                <h1 className="text-sm font-semibold bg-blue-300 p-4"> 
                                    ...
                                    SE CALCULA CON BASE EN LA PRIMA COMPUTABLE AJUSTADA 1ER AÑO ( PCA ${dollarUSLocale.format(dataBonoRango[0].PCA)}) <br />
                                        SE OTORGA UN PORCENTAJE SOBRE LA PRIMA COMPUTABLE DE CONSERVACION (PCC  ${dollarUSLocale.format(dataBonoRango[0].PCC)} )  <br />
                                ...
                                <div className="bg-blue-300 p-3">
                                    Puedes alcanzar un 1% adicional si tu persistencia llega a 99%.
                                </div>
                            </div>
                        </div>
                    </div>
