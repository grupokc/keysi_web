...
interface BonosRangos146Props {
  Bono_Periodo: string;
}

const BonosRangos146: React.FC<BonosRangos146Props> = ({ Bono_Periodo }) => {
            ...
            <div className="min-w-full overflow-hidden overflow-x-auto align-middle shadow sm:rounded-lg">
              <h1 className="text-sm font-semibold bg-blue-300 p-4">
                <div>
                  ...
                  Se otorga un Porcentaje sobre la Prima Computable Ajustada de
                  Conservación (PCAC) (${dollarUSLocale.format(dataBonoRango[0].PCC)}).<br />
                  Persistencia {dataBonoRango[0].Persistencia_24_L}
                  <br />
                </div>
              </h1>
