  ...
  const rows = [
    ...
    // 📌 PCA Vida 1er Año
    {
      ...
      total: dollarUSLocale.format(
        (dataI[0]?.QEQ_PCA_1er_Anio_Vida ?? 0) +
        (dataI[0]?.KC_PCA_1er_Anio_Vida ?? 0) +
        (dataI[0]?.KC_PCA_1er_Anio_Vida2 ?? 0)
      )
    },
    ...
    // 📌 PCA Meta 1er Año
    {
      ...
      pendientePago: "--",
      total: dollarUSLocale.format(
        (dataI[0]?.QEQ_PCA_1er_Anio_Meta ?? 0) +
        (dataI[0]?.KC_PCA_1er_Anio_Meta ?? 0) +
        (dataI[0]?.KC_PCA_1er_Anio_Meta2 ?? 0)
      )
    },
    ...
    },
    {
      ...
      kc2Valor: "--",
      pendientePago: "--",
      total: dollarUSLocale.format(dataI[0]?.Primordial_PP_1er_Anio ?? 0 + dataI[0]?.KC_PP_Primordial ?? 0) // Total = mismo valor (no hay cálculos adicionales)
    },
    {
      isTitle: true,
      key: "gmm_title",
    ...
    <>
      ...
      <div className="flex w-full flex-row overflow-x-auto sm:overflow-visible z-100">
          {dataI.length > 0 ? (
            <>
              <Card>
                <CardHeader className="bg-blue-500 text-white p-3 rounded-t-small text-lg font-semibold">
                  Indicadores
                </CardHeader>
                ...
                <CardBody>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-4 gap-x-4 gap-y-2 p-4 border rounded-lg bg-gray-50">
                        <div className="flex flex-col">
                            <p className="text-xs font-semibold text-gray-600">Nombre Agente</p>
                            <p className="text-sm text-gray-800">{dataI[0]?.Generales_Nombre_De_Agente}</p>
                        </div>
                        <div className="flex flex-col">
                            <p className="text-xs font-semibold text-gray-600">Clave MetLife</p>
                            <p className="text-sm text-gray-800">{dataI[0]?.Clave_Agente_Met}</p>
                        </div>
                        <div className="flex flex-col">
                            <p className="text-xs font-semibold text-gray-600">Clave Pegasus</p>
                            <p className="text-sm text-gray-800">{dataI[0]?.Clave_Agente_Pegasus}</p>
                        </div>
                        <div className="flex flex-col">
                            <p className="text-xs font-semibold text-gray-600">Fecha de Ingreso</p>
                            <p className="text-sm text-gray-800">{dataI[0]?.Fecha_Ingreso}</p>
                        </div>
