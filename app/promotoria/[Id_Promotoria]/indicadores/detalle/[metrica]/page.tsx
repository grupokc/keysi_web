...
export default async function AgentesIndicadoresDetailPage({
  ...
  console.log(params)
  let title = params.metrica.replace(/titan/gi, '');
  ...
  return (
    <div className="flex flex-col items-center justify-center p-4">
      <h1 className="text-center text-3xl font-bold text-gray-800">{title}</h1>
      <p className="mt-2 w-full rounded border-l-4 border-yellow-500 bg-yellow-100 p-3 text-center text-sm text-yellow-700">
